...
export const ServicesData = {
  ...
  SERVICE_EVENT_PROCESS_ERROR: { action: "SERVICE_EVENT_PROCESS_ERROR", level: "error", message: "[Service: $$NAME$$] Event Process Error", type } as IConstantData,
  SERVICE_EVENT_PROCESS_EFFECT_ERROR: { action: "SERVICE_EVENT_PROCESS_EFFECT_ERROR", level: "error", message: "[Service: $$NAME$$] Event Process Effect Error", type } as IConstantData,
};

...
export const ServicesNotifyData = {
  ...
  SERVICE_EVENT_PROCESS_ERROR: composeNotifyData(ServicesData.SERVICE_EVENT_PROCESS_ERROR),
  SERVICE_EVENT_PROCESS_EFFECT_ERROR: composeNotifyData(ServicesData.SERVICE_EVENT_PROCESS_EFFECT_ERROR),
};
